...
const perguntas = [
      ...
      alternativas: [
        {
          ...
          afirmacao: ["Sim, ela pode ajudar em alguns apectos"
        ]
        },
        {
          texto:
            "Me preocupo com as pessoas que perderão seus empregos para máquinas e defendem a importância de proteger os trabalhadores.",
          afirmacao: ["Realmente essa parte pode prejudicar muitos ciadoẽs"
        ]
        },
      ],
    },
    {
      ...
      alternativas: [
        {
          texto:
            "Critransition: background-color 0.3s;ar uma imagem utilizando uma plataforma de design como o Paint.",
          afirmacao: ["criação de imagem com o paint",
        ]
        },
        {
          texto: "Criar uma imagem utilizando um gerador de imagem de IA.",
          afirmacao: ["imagem gerada por IA",
        ]
        },
      ],
    },
      ...
      alternativas: [
        {
          ...
          afirmacao: ["isso não é verdade, vocẽ só especificou oque vocẽ queria",
        ]
        },
        {
          texto:
            "O chat pode ser uma tecnologia muito avançada, mas é preciso manter a atenção pois toda máquina erra, por isso revisar o trabalho e contribuir com as perspectivas pessoais é essencial.",
          afirmacao: ["sim, é precio tomar cuidado",
        ]
        },
      ],
    },
